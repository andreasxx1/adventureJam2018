(function() {
	...
	class GameButton extends GameObject { // GameButton instead of Button due reserved word "Button".
		constructor({ id, x, y, w, h, states, screens, index, constructor, callback, text, fontStyle, fontSize, fontColor }){
			super({ id, x, y, w, h, states: states || null, screens, index, constructor });
			// 
